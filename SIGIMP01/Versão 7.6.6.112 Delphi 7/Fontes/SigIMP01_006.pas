...
type
  ...
  Tfr_ManPedido = class(TForm)
    ...
    procedure ExcelBorders(Col1, Col2: string; LinIni, LinFim: integer);
    procedure PackagesInformation(Col1, Col2: String);
...
procedure Tfr_ManPedido.ExcelBorders(Col1, Col2: string; LinIni, LinFim: integer);
begin
   with ExcelWorkSheet.Range[Col1 + IntToStr(LinIni), Col2 + IntToStr(LinFim)] do
   begin
...
procedure Tfr_ManPedido.PackagesInformation(Col1, Col2: String);
begin
   { TOTAL PACKAGES INFORMATION }
   LinhaAux := Linha;

   with ExcelWorkSheet.Range[Col1 + IntToStr(Linha), Col2 + IntToStr(Linha)] do
   begin
      MergeCells := True;
   ...
   ExcelBorders(Col1, Col2, LinhaAux, Linha);
...
procedure EspecificationPage(Tipo: String);
begin
   ...
   ExcelBorders('C', s, LinhaAux, Linha);
...
begin
   ...
   ExcelBorders('A', 'J', LinhaAux, Linha2);
   ...
   ExcelBorders('A', 'J', Linha, Linha+1);

   Linha := Linha + 3;

   { PACKAGES INFORMATION }
   PackagesInformation('A', 'J');
   ...
   ExcelBorders('A', 'E', Linha1, Linha);
   ExcelBorders('F', 'J', Linha1, Linha);
...
begin
  ...
  begin
   ...
   begin
     ...
     { bordas }
     ExcelBorders('A', 'A', LinhaAux, Linha);
     ExcelBorders('C', 'C', LinhaAux, Linha);
  ...
  { Congelar Painéis }
  ExcelWorkSheet.Range['A24','A24'].Select;
...
begin
   ...
   begin
     ...
     begin
       ...
       if (qryPedidoies_pallets.AsString = 'S') then
         ExcelBorders('A', 'W', Linha, Linha)
       else
         ExcelBorders('A', 'S', Linha, Linha);
...
begin
  ...
  begin
    ...
    ExcelBorders('A', 'I', LinhaAux, Linha);
  end;
end;
...
begin
   ...
   Linha := Linha + 2;
    ...
    { Bordas no cabeçalho }
    ExcelBorders('A', 'Y', Linha, LinhaAux);
