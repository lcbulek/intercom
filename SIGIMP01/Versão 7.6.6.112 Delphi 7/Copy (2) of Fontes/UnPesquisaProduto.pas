...
begin
   ...
   begin
     ...
     { descrição reduzida em português }
...
begin
  { buscar pela descrição em Inglês }
  if (Key = VK_RETURN) then
  begin
    if Not(qryProduto.IsEmpty) then
...
begin
  ...
  { Pesquisar Histórico de Compras do Produto }
  ...
  (*             As imagens ficam na pasta padrão: Pasta da Empresa Usuária + '\PASTA DO CLINETE\PRODUCTS DATABASE\IMAGES\' + CodProduto + '.JPG' *)
  (*                                                                                                                                              *)
...
begin
  ...
  { Criar Listas apenas na Alteração }
  if (AcaoMenuP = acmEdit) then GerarListasExcel;

  { Quando chamado do menu "Pesquisar Produtos", excluir os comentários das células }
  ...
  with Produtos do
  begin
    { Ler todo o Cadastro de Produtos e transfêrir para a planilha }
    Linha := 4;
    while Not(EOF) do
    begin
      ...
      begin
        ...
        sHash := Text;
        { Quando chamado do menu "Pesquisar Produtos", alterar mostrar apenas o comentário sobre as cores do Código do Produto }
        if (AcaoMenuP = acmSearch) then
        begin
           AddComment('Cores para o Código do Produto (cor da fonte): vermelha indica Licença de Importação, Azul indica Licenciado pelo INMETRO e Rosa ambos conforme indicado nas colunas AC e AD.');
      ...
      begin
        ...
        begin
           if (Linha > 4) then
           begin
              AddComment('Clicar na célula do fornecedor, para que seja mostrado o combobox e usar a seta para selecionar o Fornecedor da lista.');
      ...
      begin
        ...
        begin
           if (Linha > 4) then
           begin
              AddComment('Clicar na célula do cliente para que seja mostrado o combobox e usar a seta para selecionar o Cliente da lista.');
              Comment.Shape.Height := 50;
              Comment.Shape.Width := 200;
              Comment.Visible := False;
           end;
      ...
      begin
        ...
        begin
           if (Linha > 4) then
           begin
              AddComment('Clicar na célula do Tipo de Produto, para que seja mostrado o combobox e usar a seta para selecionar o Tipo de Produto da lista.');
              Comment.Shape.Height := 50;
              Comment.Shape.Width := 200;
              Comment.Visible := False;
           end;
      ...
      begin
        ...
        begin
           if (Linha >4) then
           begin
              AddComment('Clicar na célula da Unidade para que seja mostrado o combobox e usar a seta para selecionar o Unidade de Medida da lista.');
              Comment.Shape.Height := 50;
              Comment.Shape.Width := 200;
              Comment.Visible := False;
           end;
      ...
      begin
        ...
        begin
          ...
          { col S - Peso Bruto da Caixa de Exportação }
      ...
      begin
          ...
          begin
            ...
            begin
               AddComment('Se alterar o Preço Unitário altere também as colunas "Observações para preços" e a "Data do Preço" para a importação correta dos dados.');
               Comment.Shape.Height := 50;
               Comment.Shape.Width := 250;
               Comment.Visible := False;
            end;
          ...
          { col Z - Preço Unitário Fornecedor - não USADO - coluna em branco }


          { col AA - observação preço }
      ...
      {col AE - Licença para Importação }
      ...
      begin
        ...
        begin
           if (Linha >4) then
           begin
              AddComment('Clicar na célula da Licença de Importação, para que seja mostrado o combobox e usar a seta para selecionar "S" ou "N" da lista.');
              Comment.Shape.Height := 50;
              Comment.Shape.Width := 250;
              Comment.Visible := False;
           end;
           { Combo Licença Importação }
           with Validation do
           begin
             Delete;
      ...
      begin
        ...
        begin
           if (Linha >4) then
           begin
              AddComment('Clicar na célula de Licençiado pelo INMETRO, para que seja mostrado o combobox e usar a seta para selecionar "S" ou "N" da lista.');
              Comment.Shape.Height := 50;
              Comment.Shape.Width := 250;
              Comment.Visible := False;
           end;
