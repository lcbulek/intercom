...
begin
  ...
  OpenDialog.Filter := 'Excel|*.xls';
  OpenDialog.Title := 'Importação de Pedidos ';
...
begin
  ...
  OpenDialog.Filter := 'Excel|*.xls';
  OpenDialog.Title := 'Importação de Produtos';
...
begin
  ...
  OpenDialog.Filter := 'Excel|*.xls';
  OpenDialog.Title := 'Alteração de Pedidos';
...
begin
  ...
  OpenDialog.Filter := 'Excel|*.xls';
  OpenDialog.Title := 'alteração de Faturas';
...
begin
  inherited;
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 0) = 0 then lbLista.Caption := 'Não adicionada'
                                                            else lbLista.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 1) = 0 then lbPedido.Caption := 'Não adicionado'
                                                            else lbPedido.Caption := 'Adicionado';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 3) = 0 then lbProduto.Caption := 'Não adicionada'
                                                            else lbProduto.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 4) = 0 then lbShipList.Caption := 'Não adicionada'
                                                            else lbShipList.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 5) = 0 then lbItensEmb.Caption := 'Não adicionada'
                                                            else lbItensEmb.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 6) = 0 then lbItensEmbFat.Caption := 'Não adicionada'
                                                            else lbItensEmbFat.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 7) = 0 then lbPlanBranca.Caption := 'Não adicionada'
                                                            else lbPlanBranca.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 8) = 0 then lbAlteracaoPedidos.Caption := 'Não adicionada'
                                                            else lbAlteracaoPedidos.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 9) = 0 then lbAlteracaoFaturas.Caption := 'Não adicionada'
                                                            else lbAlteracaoFaturas.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 10) = 0 then lbModeloPedidos.Caption := 'Não adicionada'
                                                             else lbModeloPedidos.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 11) = 0 then lbProdEmbarcados.Caption := 'Não adicionada'
                                                             else lbProdEmbarcados.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 12) = 0 then lbResumoPedidos.Caption := 'Não adicionada'
                                                             else lbResumoPedidos.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 13) = 0 then lbResumoFaturas.Caption := 'Não adicionada'
                                                             else lbResumoFaturas.Caption := 'Adicionada';
  if GetBit(Parametro_Comercialies_modelo.AsInteger, 14) = 0 then lbShipMarks.Caption := 'Não adicionada'
...
begin
  inherited;
  OpenDialog.Filter := 'Excel|*.xls';
  OpenDialog.Title := 'Cotações Recebidas';
