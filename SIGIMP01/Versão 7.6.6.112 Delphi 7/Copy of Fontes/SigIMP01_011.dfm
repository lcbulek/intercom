object fr_HistoricoPrecos: Tfr_HistoricoPrecos
  Left = 750
  Top = 354
  HelpType = htKeyword
  HelpKeyword = '011'
  ...
  Caption = 'Hist'#243'rico de Pre'#231'os de um  Produto'
  ClientHeight = 162
  ClientWidth = 348
  Color = clBtnFace
  ...
  object edtCodProduto: TEdit
    ...
    Height = 21
    Hint = 
      'Informe o C'#243'digo do Produto quando quiser ver o hist'#243'rico '#13#10'some' +
      'nte de um produto sem a necessidade de '#13#10'indicar o Cliente ou Fo' +
      'rnecedor. '
