...
type
  ...
  Tfr_ManPedido = class(TForm)
    ...
    procedure PackagesInformation(Col1, Col2: String; Var Linha: integer);
...
procedure Tfr_ManPedido.PackagesInformation(Col1, Col2: String; Var Linha: integer);
Var
  LinhaAux : Integer;
  s : string;
begin
   ...
   with ExcelWorkSheet.Range[Col1 + IntToStr(LinhaAux), Col2 + IntToStr(Linha)] do
   begin
